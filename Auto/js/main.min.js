...
//! Логика для выезжающего меню
$(window).on("scroll",(function(){window.pageYOffset>120?$(".cap-scroll").addClass("active"):window.pageYOffset<120&&$(".cap-scroll").removeClass("active")}));//! Логика для табов
var r=$(".tab-btn"),n=Array.from($(".tab-content__tab"));r.on("click",(function(e){var t,r,a=Array.from($(e.currentTarget.children)),i=Array.from(e.target.classList),o=e.target.dataset.index;window.screen.width>=768?(console.log(">"),i.forEach((function(t){var r,i;
//! Проверяем ширину экрана
"active"!=t&&"tab-btn"!=t&&(r=a,i=e.target,r.forEach((function(e){console.log(e.children),e.classList.remove("active"),i.classList.add("active")})),n.forEach((function(e){e.dataset.index==o?e.classList.add("active"):e.classList.remove("active")})))}))):(t=a,r=e.target,t.forEach((function(e){e.children[0].classList.remove("active"),r.classList.add("active"),e.children[1].dataset.index==r.dataset.index&&$(e.children[1]).slideToggle()})))}));new Swiper(".swiper-container",{slidesPerView:1,spaceBetween:14,breakpoints:{768:{slidesPerView:2},992:{slidesPerView:3}},direction:"horizontal",loop:!0,pagination:{el:".swiper-pagination"}});var a=$(".swiper-pagination").width()/2;$(".swiper-pagination").css("transform","translateX(-".concat(a,"px)")),$(window).on("load",(function(){var e=$(".swiper-wrapper"),t=Array.from(e[0].children);$(e).on("click",(function(e){var r=e.target.offsetParent,n=$(r).data("swiper-slide-index");$(r).toggleClass("active"),t.forEach((function(e){Number(e.dataset.swiperSlideIndex)==n?$(e).addClass("active"):$(e).removeClass("active")}))}))}))}]);